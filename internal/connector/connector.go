...
func (m Msg) Reply(msgName string, data interface{}, wantReply bool) (<- chan Msg, error) {
    if !m.reply {
...
func (c *Connector) SendMsg(msgName string, data interface{}, reply bool) <-chan Msg {
	msg := Msg{
		Name:  msgName,
		Data:  data,
		reply: reply,
